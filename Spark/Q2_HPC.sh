...
#$ -o Q2_180228768.output #This is where your output and errors are logged.
...
spark-submit --driver-memory 16g --executor-memory 16g --master local[10] Q2_180228768.py
